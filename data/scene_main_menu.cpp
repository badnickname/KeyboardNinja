...
char SceneMainMenu::step() {
  ...
  if (sf::Mouse::getPosition(*app).x > 310 &&
      sf::Mouse::getPosition(*app).x < 920 &&
      sf::Mouse::getPosition(*app).y > 221 &&
      sf::Mouse::getPosition(*app).y < 324) {
  ...
  if (sf::Mouse::getPosition(*app).x > 310 &&
      sf::Mouse::getPosition(*app).x < 920 &&
      sf::Mouse::getPosition(*app).y > 338 &&
      sf::Mouse::getPosition(*app).y < 442) {
  ...
  if (sf::Mouse::getPosition(*app).x > 310 &&
      sf::Mouse::getPosition(*app).x < 920 &&
      sf::Mouse::getPosition(*app).y > 455 &&
      sf::Mouse::getPosition(*app).y < 568) {
